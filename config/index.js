...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxb1fcc94b892ffc78',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'b0a0a62bb8a7b61f08f67ae24af66af9',
  ...
  USERS: [
    {
      ...
      id: 'opP5X67Q2gFlzzyBMmuE8TaxGAtQ',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '0mNpyCNmhtzxrmqyvv8BE7TwIyby9sb_v4vpg26W_Xc',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '郑州',
